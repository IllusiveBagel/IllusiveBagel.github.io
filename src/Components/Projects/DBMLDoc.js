...
export default class DBMLDocs extends React.Component {
    render() {
        return (
            <div>
                <h1 className="Content-Title">DBML Docs</h1>
                ...
                <div className="Content-Links">
                   <a className="Content-Link" href="https://github.com/IllusiveBagel/DBMLDocs" target="_blank" rel="noreferrer">Github</a>
                   <a className="Content-Link" href="https://github.com/IllusiveBagel/DBMLDocs" target="_blank" rel="noreferrer">Live Demo</a> 
                </div>
            </div>
        )
    }
