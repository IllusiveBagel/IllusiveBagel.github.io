...
export default class Synaptic extends React.Component {
    render() {
        return (
            <div>
                <h1 className="Content-Title">Synaptic Implementation</h1>
                ...
                <div className="Content-Links">
                    <a className="Content-Link" href="https://github.com/IllusiveBagel/Synaptic-Implementation" target="_blank" rel="noreferrer">Github</a>
                    <a className="Content-Link" href="https://illusivebagel.github.io/Synaptic-Implementation/" target="_blank" rel="noreferrer">Live Demo</a>
                </div>
            </div>
        )
    }
